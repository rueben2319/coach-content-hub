    ...
    <div className="max-w-5xl mx-auto px-2 sm:px-6 py-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-3 mb-6">
        ...
        <div className="flex gap-1 ml-auto">
          <Button variant="ghost" size="icon" className="border border-gray-200" disabled>
            <Grid className="w-5 h-5 text-gray-400" />
          </Button>
          <Button variant="ghost" size="icon" className="bg-green-500 hover:bg-green-600 text-white border border-green-500">
